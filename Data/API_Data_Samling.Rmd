...
```{r}
hld_arb <- hld_arb %>% 
  filter(NACE2007 %in% c("00-99", "01-03", "05-09", "10-33", "35-39", "41-43", "45-47", "49-53", "55-56", "58-63", "64-66", "68-75", "77-82", "84", "85", "86-88", "90-99", "00")) %>% select(-NAstatus)
```

```{r}
hld_arb <- hld_arb[-c(235:244), ]
...
```{r}
sun_arb <- sun_arb %>% 
  filter(NACE2007 %in% c("00-99", "01-03", "05-09", "10-33", "35-39", "41-43", "45-47", "49-53", "55-56", "58-63", "64-66", "68-75", "77-82", "84", "85", "86-88", "90-99", "00"))
```
