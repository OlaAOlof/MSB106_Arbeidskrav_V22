...
Haug_arb_GINI <- Haug_arb_GINI %>% 
  mutate(
    ...
    Eir_Er_Industri = Industri/`Alle Næringer`,
    Eir_Er_Helse = `Helse- og Sosialtjenester`/`Alle Næringer`,
    Ein_En_Primær = nasjonalt_arbeidssted$`Jordbruk, Skogbruk og Fiske`/`Alle Næringer`,
    Ein_En_Industri = nasjonalt_arbeidssted$Industri/`Alle Næringer`,
    Ein_En_Helse = nasjonalt_arbeidssted$`Helse- og Sosialtjenester`/`Alle Næringer`,
  ...
  Tysv_arb_GINI %>% 
    select(År, `Alle Næringer`, Eir_Er_Primær, Eir_Er_Industri, Eir_Er_Helse, Ein_En_Primær, Ein_En_Industri, Ein_En_Helse, LQ_Primær, LQ_Industri, LQ_Helse),
             col.names = c("År",
                           ...
                           "Helse")) %>% 
  add_header_above(c(" "=2, "Eir/Er" = 3, "Ein/En" = 3, "LQ" = 3)) %>% 
  add_header_above(c("Tysvær: Lokalkvotient"=11))
```
...
Odda_arb_GINI <- Odda_arb_GINI %>% 
  mutate(
    ...
    Eir_Er_Industri = Industri/`Alle Næringer`,
    Eir_Er_Helse = `Helse- og Sosialtjenester`/`Alle Næringer`,
    Ein_En_Primær = nasjo_arb_red$`Jordbruk, Skogbruk og Fiske`/`Alle Næringer`,
    Ein_En_Industri = nasjo_arb_red$Industri/`Alle Næringer`,
    Ein_En_Helse = nasjo_arb_red$`Helse- og Sosialtjenester`/`Alle Næringer`,
    LQ_Primær = Eir_Er_Primær / Ein_En_Primær,
    LQ_Industri = Eir_Er_Industri / Ein_En_Industri,
    LQ_Helse = Eir_Er_Helse / Ein_En_Helse) %>% 
  mutate_if(is.numeric, round, digits=4)
