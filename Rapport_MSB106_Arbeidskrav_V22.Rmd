...
Odda_bos_GINI <- Odda_bos_GINI %>% 
  mutate(
    ...
    Ein_En_Primær = nasjo_bos_red$`Jordbruk, Skogbruk og Fiske`/nasjonalt_bosted$`Alle Næringer`,
    Ein_En_Industri = nasjo_bos_red$Industri/nasjonalt_bosted$`Alle Næringer`,
    Ein_En_Helse = nasjo_bos_red$`Helse- og Sosialtjenester`/nasjonalt_bosted$`Alle Næringer`,
