...
# Kanskje fjernet det under denne linja?? Dette er overflødisk no. Trenger ikkje dette lengre, med unntak av excell innlesing.
...
# Kanskje fjernet det ovenfor denne linja?? Dette er overflødisk no. Trenger ikkje dette lengre, med unntak av excell innlesing.
...
write_xlsx(syssel_arb, file="Sysselsetting_Etter_Arbeidsplass.xlsx")
write_xlsx(syssel_bos, file="Sysselsetting_Etter_Bosted.xlsx")
write_xlsx(nasjonalt_arbeidssted, file= "Nasjonalt_Arbeidssted.xlsx")
write_xlsx(nasjonalt_bosted, file="Nasjonalt_Bosted.xlsx")
write_xlsx(Pendling, file="Pendling.xlsx")
```
